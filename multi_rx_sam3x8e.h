...
void computeRC() {
  ...
  AUX_1f = rcValue[AUX1]*0.3809523;
  AUX_2f = rcValue[AUX2]*0.3809523;
  ...
  AUX_1 = AUX_1 + (AUX_1f - AUX_1) * 0.02 / tarremote;
  AUX_2 = AUX_2 + (AUX_2f - AUX_2) * 0.02 / tarremote;
//  AUX_3 = AUX_3 + (AUX_3f - AUX_3) * 0.02 / tarremote;
//  AUX_4 = AUX_4 + (AUX_4f - AUX_4) * 0.02 / tarremote;
}
void RC_Calibrate() {
