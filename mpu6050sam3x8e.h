...
void mpu6050_Accel_Values()
{
  ...
  Wire.endTransmission();
    accelRaw[XAXIS] = ((result[0] << 8) | result[1])*-1 + 61;//+ 105 + 100  max=4054.46, min=-4149.48
    accelRaw[YAXIS] = ((result[2] << 8) | result[3]) + 167;// - 45 - 35      max=4129.57, min=-4070.64
...
void Mag5883Read()
{
  Wire1.beginTransmission(HMC5883_Address);  //Tell the HMC5883 where to begin reading data
...
//Config Offset Accelerameter
// acc_offsetX - กรณีเป็น + แกน Pitch จะเอียงไปด้านหน้า
// acc_offsetX - กรณีเป็น - แกน Pitch จะเอียงไปด้านหลัง
// acc_offsetY - กรณีเป็น + แกน Roll จะเอียงไปด้านขวา
// acc_offsetY - กรณีเป็น - แกน Roll จะเอียงไปด้านซ้าย
acc_offsetX = 0.09;//-0.18 0.11 -0.36  Trim PITCH CONTROL   -10.07  -10.55  -9.82  //0.10   //Best Solution 0.20
acc_offsetY = 0.02;//0.16 -0.14 0.18 Trim ROLL CONTROL     10.39  9.74  11        //0.01  //Best Solution -0.12
acc_offsetZ = 0.0;

//Default Config
//acc_offsetX = -0.08;//-0.18 0.11 -0.36  Trim PITCH CONTROL   -10.07	-10.55	-9.82
//acc_offsetY = 0.19;//0.16 -0.14 0.18 Trim ROLL CONTROL     10.39	9.74	11
