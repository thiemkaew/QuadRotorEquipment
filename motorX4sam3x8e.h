...
//Pin 34 Active Servo
//------------------------------------------
int MOTOR_Servo1_PIN = 34;//PWML0 = pin 34
//------------------------------------------
...
#define PWM_DUE_Servo 20000   // in us
...
void motor_initialize() 
{
  ...
  pinMode(MOTOR_Servo1_PIN,OUTPUT);
  ...
  configOneMotor(0, PWM_DUE_Servo);
  motor_command_all();
}
void motor_command() 
{
  ...
  //Pin 34 Active Servo
  //-----------------------------------------------------
  PWMC_SetDutyCycle(PWM, 0, Servo_trigger);
  //-----------------------------------------------------
}
  /********************************************************************/
